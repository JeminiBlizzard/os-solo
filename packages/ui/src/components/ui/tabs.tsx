...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center text-gray-60 border-b border-gray-20',
      className
    )}
    {...props}
  />
